    ...
    block seq {
      seq {
        seq {
          addr_of ctx
          nop
          call @cursive_x3a_x3aruntime_x3a_x3acontext_x3a_x3acpu (addr_of)
        }
        bind %domain = method_call
      }
      seq {
        seq {
          read %domain
          parallel {
            ...
            body:
              block seq {
                spawn {
                  captured_env:
                    bind %spawn_env_var_3 = spawn_env
                  body:
                    nop
                  body_result: unit
                  result: spawn_handle
                ...
                seq {
                  ...
                  clear_panic
                  call @cursive_x3a_x3aruntime_x3a_x3adrop_x3a_x3aSpawnHandle (%h, %__panic)
                  seq {
