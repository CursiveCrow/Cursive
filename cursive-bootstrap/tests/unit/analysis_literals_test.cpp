...
using cursive0::analysis::CheckLiteralExpr;
...
using cursive0::analysis::TypeString;
using cursive0::analysis::TypeLiteralExpr;
...
int main() {
...

  {
    ...
    cursive0::analysis::IdentTypeFn type_ident =
