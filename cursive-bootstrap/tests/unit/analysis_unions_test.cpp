...
#include "cursive0/analysis/composite/unions.h"
#include "cursive0/analysis/types/types.h"
#include "cursive0/syntax/ast.h"

namespace {

using cursive0::analysis::CheckUnionDirectAccess;
...
using cursive0::analysis::TypeUnionIntro;
...
int main() {
  ...
  {
    TypeEnv env;
    env.types["r"] = cursive0::analysis::MakeTypePath({"Record"});
    ExprTypeFn type_expr = [&](const auto& node) { return env.TypeOf(node); };
