...
using cursive0::analysis::ResPatternResult;
using cursive0::analysis::ResolveContext;
using cursive0::analysis::ResolveExpr;
using cursive0::analysis::ResolvePattern;
using cursive0::analysis::ResolveStmtSeq;
