...
using cursive0::sema::BitcopyType;
using cursive0::sema::CastValid;
using cursive0::sema::CheckIfExpr;
using cursive0::sema::CheckPlaceAgainst;
using cursive0::sema::EqType;
using cursive0::sema::ExprTypeResult;
using cursive0::sema::IsPlaceExpr;
...
using cursive0::sema::StmtTypeContext;
using cursive0::sema::StripPerm;
using cursive0::sema::Entity;
using cursive0::sema::EntityKind;
using cursive0::sema::EntitySource;
using cursive0::sema::IdKeyOf;
using cursive0::sema::TypeBinding;
using cursive0::sema::TypeBinaryExpr;
using cursive0::sema::TypeCastExpr;
using cursive0::sema::TypeEnv;
using cursive0::sema::TypeExpr;
using cursive0::sema::TypeIdentifierExpr;
using cursive0::sema::TypeIfExpr;
using cursive0::sema::TypePlace;
using cursive0::sema::TypePrim;
using cursive0::sema::TypeRange;
using cursive0::sema::TypeRangeExpr;
using cursive0::sema::TypeRef;
using cursive0::sema::TypeUnaryExpr;
using cursive0::sema::TypeAddressOfExpr;
using cursive0::sema::TypeAllocExpr;
using cursive0::sema::TypeDerefExpr;
using cursive0::sema::TypeDerefPlace;
using cursive0::sema::TypeEnumLiteralExpr;
using cursive0::sema::TypeFieldAccessExpr;
using cursive0::sema::TypeFieldAccessPlace;
using cursive0::sema::TypeMoveExpr;
using cursive0::sema::TypePathExpr;
using cursive0::sema::TypePathType;
using cursive0::sema::TypePerm;
using cursive0::sema::TypePropagateExpr;
using cursive0::sema::TypeRecordExpr;
using cursive0::sema::TypeTransmuteExpr;
...
int main() {
...

  {
    ...
    assert(res.ok);
    assert(std::holds_alternative<cursive0::sema::TypeFunc>(res.type->node));
  }
...

  {
    ...
    auto res = TypeAddressOfExpr(ctx, type_ctx, expr, env);
    assert(res.ok);
    const auto* ptr = std::get_if<cursive0::sema::TypePtr>(&res.type->node);
    assert(ptr);
