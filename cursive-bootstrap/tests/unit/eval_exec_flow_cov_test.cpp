...
using cursive0::eval::ExecSeqSigma;
using cursive0::eval::ExecSigma;
...
void TestExecSeq() {
...

  {
    ...
    SetExprType(expr_types, expr, cursive0::analysis::MakeTypePrim("i32"));
...
void TestExecBindings() {
...

  {
    ...
    SetExprType(expr_types, init, cursive0::analysis::MakeTypePrim("i32"));
...
void TestExecAssign() {
...

  {
    ...
    SetExprType(expr_types, val, cursive0::analysis::MakeTypePrim("i32"));
...

  {
    ...
    SetExprType(expr_types, rhs, cursive0::analysis::MakeTypePrim("i32"));
...
void TestExecOtherStmts() {
...

  {
    ...
    SetExprType(expr_types, opts, cursive0::analysis::MakeTypePrim("i32"));
    auto body = MakeBlock({});
...

  {
    ...
    SetExprType(expr_types, value, cursive0::analysis::MakeTypePrim("i32"));
