...
Value MakeStringValue(std::string bytes) {
  cursive0::semantics::StringVal v;
  v.state = cursive0::sema::StringState::View;
...
void TestIfExprs() {
  ...
  SetExprType(expr_types, cond_true, cursive0::sema::MakeTypePrim("bool"));
  SetExprType(expr_types, cond_false, cursive0::sema::MakeTypePrim("bool"));
  SetExprType(expr_types, value_one, cursive0::sema::MakeTypePrim("i32"));
  SetExprType(expr_types, value_two, cursive0::sema::MakeTypePrim("i32"));
...
void TestMatchExprs() {
  ...
  SetExprType(expr_types, zero, cursive0::sema::MakeTypePrim("i32"));
  SetExprType(expr_types, one, cursive0::sema::MakeTypePrim("i32"));
  SetExprType(expr_types, two, cursive0::sema::MakeTypePrim("i32"));
  ...
  SetExprType(expr_types, guard_true, cursive0::sema::MakeTypePrim("bool"));
  SetExprType(expr_types, guard_false, cursive0::sema::MakeTypePrim("bool"));
  ...
  SetExprType(expr_types, match_guard_true_scrut, cursive0::sema::MakeTypePrim("i32"));
  ...
  SetExprType(expr_types, match_guard_false_scrut, cursive0::sema::MakeTypePrim("i32"));
  ...
  SetExprType(expr_types, match_guard_ctrl_scrut, cursive0::sema::MakeTypePrim("i32"));
...
void TestLoopConditional() {
...

  {
    ...
    SetExprType(expr_types, false_expr, cursive0::sema::MakeTypePrim("bool"));
...

  {
    ...
    SetExprType(expr_types, break_val, cursive0::sema::MakeTypePrim("i32"));
...
void TestLoopIter() {
...

  {
    Sigma sigma;
    PushScope(sigma, nullptr);
    cursive0::semantics::ArrayVal array;
...
void TestMethodCall() {
  ...
  const auto fs_addr = cursive0::semantics::AllocAddr(sigma);
  cursive0::semantics::WriteAddr(sigma, fs_addr, Value{cursive0::semantics::UnitVal{}});
  sigma.addr_tags[fs_addr] = cursive0::semantics::RuntimeTag{cursive0::semantics::RuntimeTagKind::ScopeTag, scope_id};
  sigma.fs_handles[fs_addr] = cursive0::semantics::FileSystemHandle{std::nullopt, ""};

  cursive0::semantics::RawPtrVal raw;
  raw.qual = cursive0::sema::RawPtrQual::Imm;
  raw.addr = fs_addr;
  cursive0::semantics::DynamicVal dyn;
