...
using cursive0::analysis::TypeTupleAccessPlace;
using cursive0::analysis::TypeTupleAccessValue;
using cursive0::analysis::TypeTupleExpr;
...
int main() {
...

  {
    ...
    const auto* prim = std::get_if<cursive0::analysis::TypePrim>(&perm->base->node);
