...
using cursive0::semantics::FloatVal;
using cursive0::semantics::IntVal;
...
void TestCastValCoverage() {
  ...
  SetExprType(expr_types, lit_id, cursive0::sema::MakeTypePrim("i32"));
  SetExprType(expr_types, cast_id, cursive0::sema::MakeTypePrim("i32"));
  Outcome id_out = cursive0::semantics::EvalSigma(ctx, *cast_id, sigma);
  assert(IsVal(id_out));
  ...
  SetExprType(expr_types, lit_signed, cursive0::sema::MakeTypePrim("i32"));
  SetExprType(expr_types, cast_signed, cursive0::sema::MakeTypePrim("i64"));
  Outcome signed_out = cursive0::semantics::EvalSigma(ctx, *cast_signed, sigma);
  ...
  SetExprType(expr_types, lit_unsigned, cursive0::sema::MakeTypePrim("i32"));
  SetExprType(expr_types, cast_unsigned, cursive0::sema::MakeTypePrim("u32"));
  Outcome unsigned_out = cursive0::semantics::EvalSigma(ctx, *cast_unsigned, sigma);
  ...
  SetExprType(expr_types, lit_int_float, cursive0::sema::MakeTypePrim("i32"));
  SetExprType(expr_types, cast_int_float, cursive0::sema::MakeTypePrim("f32"));
  Outcome int_float_out = cursive0::semantics::EvalSigma(ctx, *cast_int_float, sigma);
  ...
  SetExprType(expr_types, lit_float, cursive0::sema::MakeTypePrim("f32"));
  SetExprType(expr_types, cast_float, cursive0::sema::MakeTypePrim("f64"));
  Outcome float_out = cursive0::semantics::EvalSigma(ctx, *cast_float, sigma);
  ...
  SetExprType(expr_types, lit_float_int, cursive0::sema::MakeTypePrim("f32"));
  SetExprType(expr_types, cast_float_int, cursive0::sema::MakeTypePrim("i32"));
  Outcome float_int_out = cursive0::semantics::EvalSigma(ctx, *cast_float_int, sigma);
  ...
  SetExprType(expr_types, lit_bool, cursive0::sema::MakeTypePrim("bool"));
  SetExprType(expr_types, cast_bool_int, cursive0::sema::MakeTypePrim("i32"));
  Outcome bool_int_out = cursive0::semantics::EvalSigma(ctx, *cast_bool_int, sigma);
  ...
  SetExprType(expr_types, lit_int_bool, cursive0::sema::MakeTypePrim("i32"));
  SetExprType(expr_types, cast_int_bool, cursive0::sema::MakeTypePrim("bool"));
  Outcome int_bool_out = cursive0::semantics::EvalSigma(ctx, *cast_int_bool, sigma);
  ...
  SetExprType(expr_types, lit_char, cursive0::sema::MakeTypePrim("char"));
  SetExprType(expr_types, cast_char_u32, cursive0::sema::MakeTypePrim("u32"));
  Outcome char_u32_out = cursive0::semantics::EvalSigma(ctx, *cast_char_u32, sigma);
  ...
  SetExprType(expr_types, lit_u32, cursive0::sema::MakeTypePrim("u32"));
  SetExprType(expr_types, cast_u32_char, cursive0::sema::MakeTypePrim("char"));
  Outcome u32_char_out = cursive0::semantics::EvalSigma(ctx, *cast_u32_char, sigma);
  assert(IsVal(u32_char_out));
  const auto* char_val = std::get_if<cursive0::semantics::CharVal>(
