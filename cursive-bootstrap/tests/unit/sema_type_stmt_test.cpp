...
void AddBinding(TypeEnv& env, const char* name, cursive0::syntax::Mutability mut,
                const TypeRef& type) {
  env.scopes.back()[cursive0::sema::IdKeyOf(name)] = {mut, type};
}
