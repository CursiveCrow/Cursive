...
using cursive0::analysis::CoerceArrayToSlice;
...
using cursive0::analysis::TypeArray;
using cursive0::analysis::TypePerm;
using cursive0::analysis::TypePrim;
using cursive0::analysis::TypeRef;
using cursive0::analysis::TypeSlice;
using cursive0::analysis::TypeIndexAccessPlace;
using cursive0::analysis::TypeIndexAccessValue;
using cursive0::analysis::TypeArrayExpr;
