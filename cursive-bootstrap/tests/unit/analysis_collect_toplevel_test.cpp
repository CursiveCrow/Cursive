...
using cursive0::analysis::CollectNames;
using cursive0::analysis::CollectNameMaps;
...
using cursive0::analysis::ItemBindings;
using cursive0::analysis::ItemOfPath;
using cursive0::analysis::ModuleNames;
using cursive0::analysis::NameMap;
using cursive0::analysis::NameMapBuildResult;
using cursive0::analysis::NameMapTable;
using cursive0::analysis::NamesStart;
using cursive0::analysis::NamesState;
using cursive0::analysis::NamesStep;
using cursive0::analysis::PatNames;
using cursive0::analysis::PathKeyOf;
using cursive0::analysis::ResolveUsingPath;
using cursive0::analysis::Scope;
using cursive0::analysis::ScopeContext;
using cursive0::analysis::UsingNames;
...
int main() {
...

  {
    ...
    const auto names = cursive0::analysis::DeclNames(mod);
    assert(names.size() == 1);

    ASTModule empty_mod = MakeModule({"empty"}, {});
    const auto empty_names = cursive0::analysis::DeclNames(empty_mod);
