...
using cursive0::analysis::CallTypeResult;
...
using cursive0::analysis::IsRecordCallee;
using cursive0::analysis::ArgsOk;
using cursive0::analysis::LowerTypeFn;
using cursive0::analysis::LowerTypeResult;
...
using cursive0::analysis::TypeCall;
...
int main() {
  {
    ...
    assert(result.ok);
    assert(result.type);
    const auto* prim = std::get_if<cursive0::analysis::TypePrim>(&result.type->node);
