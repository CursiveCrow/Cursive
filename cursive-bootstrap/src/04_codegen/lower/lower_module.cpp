...
#include "cursive0/04_codegen/lower/lower_proc.h"
#include "cursive0/04_codegen/lower/lower_stmt.h"
...
analysis::ScopeContext BuildScope(const syntax::ModulePath& module_path,
                              LowerCtx& ctx) {
