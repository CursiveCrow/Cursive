...
const std::unordered_set<std::string_view>& RuntimeSymbols() {
  static const std::unordered_set<std::string_view> syms = {
      ...
      "cursive0_spawn_create",
      "cursive0_spawn_wait",
      "cursive0_dispatch_run",
      "cursive0_cancel_token_new",
      "cursive0_cancel_token_cancel",
      "cursive0_cancel_token_is_cancelled",
      "cursive0_parallel_work_panic",
      "cursive0_panic",
      // ExecutionDomain and Context builtins
      "cursive::runtime::execution_domain::name",
      "cursive::runtime::execution_domain::max_concurrency",
      "cursive::runtime::context::cpu",
      "cursive::runtime::context::gpu",
      "cursive::runtime::context::inline",
      // CancelToken builtins and modal methods
      "CancelToken::new",
      "CancelToken::Active::cancel",
      "CancelToken::Active::is_cancelled",
      "CancelToken::Active::child",
      "CancelToken::Cancelled::is_cancelled",
      // Filesystem symbols
