...
class ArrayToSliceCodegenTests(unittest.TestCase):
    def test_array_to_slice_byref_call_preserves_data(self):
        fixture = (
            REPO_ROOT
            / "tests"
            / "compiler"
            / "fixtures"
            / "array_to_slice_byref_project"
        )
        ...
        executable = (
            fixture
            / "build"
            / "array_to_slice_byref"
            / "bin"
            / "array_to_slice_byref.exe"
        )
