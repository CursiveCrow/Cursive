...
// The EnumLayoutOf implementation is in layout_aggregates.cpp.
// This file exists to document the enum layout specification.
//
// EnumLayoutOf computes:
//   1. Discriminant type from max discriminant value
//   2. Max payload size and alignment across all variants
//   3. Total size = AlignUp(disc_size + payload_size, align)
//   4. Total align = max(disc_align, payload_align)

namespace cursive::codegen {

// EnumLayoutOf is implemented in layout_aggregates.cpp
